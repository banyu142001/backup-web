<aside class="sidenav rounded-2 navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white p-1 mx-5  <?= menu_penjualan($title) ?>" href="/penjualan">
            ...
            <li class="nav-item">
                <a class="nav-link text-white p-1 mx-5  <?= menu_stok_keluar($title) ?> " href="/stokkeluar">
