    ...
    <div class="card card-body mx-3 mx-md-4 rounded-1 border-0 shadow-0 mt-4">
        ...
        <div class="row mt-2 justify-content-center">
            <div class="col-lg-10">
                ...
                <p>Halo <strong>Nama user </strong> <br> Bantu kami dengan berikan ulasan dan pengalaman anda saat menggunakan Aplikasi myPos. Dengan itu kami dapat memperbaiki dan memperbarui sistem sesuai dengan ulasan anda. </p>
                <div class="row g-0">
